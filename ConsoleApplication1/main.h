...
#define raw_fig_path  "E:\\keti_data\\decompose_fig_2\\"    // 原始图片路径
#define decompose_path "E:\\keti_data\\decompose_fig_3\\"  // decompose生成图片的位置
#define DECOMPOSE_FLAG 1  //用来控制是 执行 视频转换成帧，还是对于每帧的处理；
...
#define MANUAL_SETTING_START_POSITION 0
#define FRAME_TO_START 59546    //decompose中开始读取的位置
#define DATE_PREFIX "_12_05"
